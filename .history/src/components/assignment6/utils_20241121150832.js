...
function groupByCity(data) {
    ...
    let result = data.reduce((result, d) => {
        ...
        currentDest.Count += 1;//Increment the count (number of routes) of ariline.
        result[d.DestCity] = currentDest; //Save the updated information in the dictionary using the airline id as key.
        return result;
    }, {})
