...
function YAxis (props) {
    ...
    return <g>
        <line x1={-5} y1={0} x2={0} y2={height} stroke='black'/>
        {yScale.domain().map(tickValue => 
            <g key={tickValue} className="">
                ...
                <text style={{textAnchor: 'end', fontSize:'10px'}} x={-10} y={yScale(tickValue) + yScale.bandwidth()/2 + 5}>
                    {tickValue}
                </text>
            </g>
        )}
