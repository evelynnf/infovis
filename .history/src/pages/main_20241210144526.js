...
function SpotifyAnalysis() {
    ...
    return (
        <Container>
            ...
            <Row>
                <Col lg={6}>
                    <h2 style={{ fontFamily: 'Georgia, serif', fontSize: '24px' }}>Danceability, Energy, and Tempo</h2>
                ...
                {/* Heatmap */}
                <Col lg={6}>
                    <h2 style={{ fontFamily: 'Georgia, serif', fontSize: '24px' }}>Keys and Modes</h2>
            ...
            <Row>
            <Col lg={6}>
                <h2 style={{ fontFamily: 'Georgia, serif', fontSize: '24px' }}>Popular Artists of Every Year</h2>
