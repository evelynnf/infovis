...
export function LineChart(props) {
  ...
  return (
    ...
    <g transform={`translate(${width - right - 80}, ${top})`}>
        ...
        <text x={20} y={10} fontSize={12} alignmentBaseline="middle">
          Danceability
        </text>

        {/* avg_energy 图例 */}
        <rect x={0} y={20} width={10} height={10} fill="green" />
        <text x={20} y={27} fontSize={12} alignmentBaseline="middle">
          Energy
        </text>

        {/* avg_tempo 图例 */}
        <rect x={0} y={40} width={10} height={10} fill="red" />
        <text x={20} y={50} fontSize={12} alignmentBaseline="middle">
          Tempo
        </text>
      </g>
      <text
